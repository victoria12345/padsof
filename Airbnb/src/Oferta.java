...
public abstract class Oferta implements Serializable{
	...
	*/
	...
	public void pagar(Demandante deman, String concepto) throws InvalidCardNumberException, FailedInternetConnectionException, OrderRejectedException{
		TeleChargeAndPaySystem.charge(Long.toString(deman.getTarjeta()), concepto, this.getPrecio());
	}
